...
function getCollectProtocolFeeData(
  amount0: number,
  amount1: number,
): { hex: string; base58: string } {
  const discriminator = getDiscriminator('collect_protocol_fee');
...
export default getCollectProtocolFeeData;

// Generate data
// const instructionData = getCollectProtocolFeeData(999, 99999);
